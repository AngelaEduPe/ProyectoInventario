...
document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch(`${base_url}index.php?c=recepcion&a=buscarPedido&id=${idPedido}`)
            ...
            .then(result => {
                ...
                if (result.success) {
                    ...
                    showMessage('info', `Pedido #${primerItem.idPedido} cargado. Complete las cantidades recibidas y presione Confirmar.`);
                } else {
    ...
    formRecepcion.addEventListener('submit', function(e) {
        ...
        inputElements.forEach(input => {
            if (input.value <= 0 && input.name.includes('[costoUnitario]')) {
                allValid = false;
