...
<div class="content container mt-5">
    <h1 class="mb-4"><i class="bi bi-bookmark"></i> Lista de Marcas</h1>
        ...
        <ul class="pagination justify-content-center">
            <?php for ($i = 1; $i <= $totalPaginas; $i++): ?>
                <li class="page-item <?= ($i == ($paginaActual ?? 1)) ? 'active' : '' ?>">
                    <a class="page-link" href="index.php?c=marca&a=listar&pagina=<?= $i ?><?= htmlspecialchars($terminoBusqueda ? '&q=' . $terminoBusqueda : '') ?>">
                        <?= $i ?>
                    </a>
                </li>
            <?php endfor; ?>
